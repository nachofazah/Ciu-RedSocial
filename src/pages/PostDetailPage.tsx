...
// Definición de tipos internos para la respuesta de la API
interface Comment {
    id: number; 
    nickName: string;
    text: string;
...
const PostDetailPage: React.FC = () => {
    ...
    const { user, fetchPostDetail, addComment } = useAuth();
    ...
    // Función para cargar todos los detalles del post (Post, Comentarios, Imágenes)
    ...
    const handleCommentSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await addComment(postId as string, commentText); 
            setCommentText(''); 
